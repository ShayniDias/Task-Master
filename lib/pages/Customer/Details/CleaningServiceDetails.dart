...
class CleaningServiceDetails extends StatefulWidget {
  final Map<String, dynamic> service;

  CleaningServiceDetails({required this.service});

  @override
  _CleaningServiceDetailsState createState() => _CleaningServiceDetailsState();
}

class _CleaningServiceDetailsState extends State<CleaningServiceDetails> {
