...
class PaintingServiceDetails extends StatefulWidget {
  final Map<String, dynamic> service;

  PaintingServiceDetails({required this.service});

  @override
  _PaintingServiceDetailsState createState() => _PaintingServiceDetailsState();
}

class _PaintingServiceDetailsState extends State<PaintingServiceDetails> {
                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => PaintingServiceDetails(service: service),
                          ),
                        );
                      },
                      child: FadeInUp(
