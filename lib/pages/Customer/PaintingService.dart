...
import 'package:taskmaster/pages/Customer/Details/PaintingServiceDetails.dart';

class PaintingServices extends StatefulWidget {
  @override
  _PaintingServicesState createState() => _PaintingServicesState();
}
        ...
        data.forEach((companyId, companyData) {
          if (companyData["services"] != null) {
            ...
            servicesData.forEach((serviceId, serviceDetails) {
              if (serviceDetails["serviceType"] == "Painting service") {
        ...
        children: [
          ...
          isLoading
            ...
            child: filteredServices.isEmpty
                ? Center(
                child: Text("No Painting Services Found",
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              PaintingServiceDetails(service: service),
                        ),
                      );
                    },
                    child: FadeInUp(
